...
seats went back on sale. No ticket can be issued, so the money has to go
somewhere.

## Decision Drivers

- A fan must never be charged for seats they did not get.
- Support should not move money by hand.
...
taken needs no refund, and reinstating a hold would sell the same seat twice.
