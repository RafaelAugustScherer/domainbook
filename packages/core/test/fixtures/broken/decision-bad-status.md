...
sold-out event needs those seats back quickly when the fan walks away.
...
version support can explain to a fan on the phone.

### Consequences

- Good, because a fan is told the same rule everywhere.
- Bad, because a slow payment method on a sold-out event will lose seats.
